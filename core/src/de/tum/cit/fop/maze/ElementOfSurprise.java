...
public class ElementOfSurprise extends GameObject{

    public ElementOfSurprise(float x, float y, int width, int height, int hitboxWidth, int hitboxHeight, float widthOnScreen, float heightOnScreen) {
